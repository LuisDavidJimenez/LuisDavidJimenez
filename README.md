...
----
## <div style="display: flex; flex-direction: row; align-items: center"> <picture>    <img src="https://github.com/7oSkaaa/7oSkaaa/blob/main/Images/Statistics.gif?raw=true" width="50px" />  </picture>      <span style="margin-bottom: 10px;">Github</span> </div>
